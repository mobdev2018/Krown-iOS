...
-(void) getAppSettings
{
    ...
    [[ProgressIndicator sharedInstance]showPIOnView:self.view withMessage:@"Preferences"];
...
- (void)openMail
{
    [super sendMailSubject:@"Krown!" toRecipents:[NSArray arrayWithObject:@"info@KrownApp.com"] withMessage:@""];
}
