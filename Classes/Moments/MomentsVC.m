...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
         [cell.lblLikeReceived setText:[NSString stringWithFormat:@"%d", (int)moment.moment_likersArray.count]];
    }
...
-(void)showMomentDetailSubviewWithMoment : (Moment *)moment fromRect:(CGRect)rect
{
    ...
    if (moment.moment_likersArray && ![moment.moment_likersArray isEqual:[NSNull null]])
    {
        [lblLikeReceived setText:[NSString stringWithFormat:@"%d",(int)moment.moment_likersArray.count]];
...
- (void)saveImageToCameraRoll
{
   ...
   // CGRect frame = [btn convertRect:sender.bounds toView:self.view];
    ...
    [self.library saveImage:imgPhotoLarge.image toAlbum:@"FlamerPro Photos" withCompletionBlock:^(NSError *error) {
        if (error!=nil) {
    ...
    if (selectedMoment.moment_likersArray && ![selectedMoment.moment_likersArray isEqual:[NSNull null]])
    {
        if (selectedMoment.moment_likersArray.count)
        {
            ...
            if (selectedMoment.moment_likersArray && ![selectedMoment.moment_likersArray isEqual:[NSNull null]])
            {
                ...
                [lblLikeOrTimer setText:[NSString stringWithFormat:@"%d likes", (int)_arrayLikes.count]];
