...
- (UIButton *)createMenuButtonViewWithImage : (UIImage *)image optionalText:(NSString *)text
{
    ...
    if (!image)
    {
        ...
        [btnMenu.titleLabel setFont:[UIFont systemFontOfSize:12.0]];
...
- (IBAction)btnDownloadImageTapped:(UIButton *)sender
{
    ...
    */
    ...
    [self.library saveImage:self.drawingView.image toAlbum:@"FlamerPro Photos" withCompletionBlock:^(NSError *error) {
        if (error!=nil) {
