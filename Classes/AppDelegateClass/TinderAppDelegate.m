...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7) {
        ...
        self.window.frame =  CGRectMake(0,0,self.window.frame.size.width,self.window.frame.size.height-0);
    }
...
//      [UIFont fontWithName:HELVETICALTSTD_LIGHT size:15.0], UITextAttributeFont, nil]];
    ...
    [[UINavigationBar appearance] setBackgroundImage:[[UIImage imageNamed:@"TopBar"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)] forBarMetrics:UIBarMetricsDefault];
    [[UINavigationBar appearance] setTitleTextAttributes:
     [NSDictionary dictionaryWithObjectsAndKeys:
      ACTION_SHEET_COLOR, NSForegroundColorAttributeName,
      [UIColor clearColor], UITextAttributeTextShadowColor,
      [NSValue valueWithUIOffset:UIOffsetMake(0, 0)], UITextAttributeTextShadowOffset,
      [UIFont fontWithName:HELVETICALTSTD_LIGHT size:15.0], NSFontAttributeName, nil]];
