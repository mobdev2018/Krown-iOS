...
//Api Url
//#define API_URL    @"http://www.zenjirabatkode.dk/Krown_Server/process.php/"
...
#define API_URL    @"http://www.zenjirabatkode.dk/Krown_Server/process_new.php/" //Define Process.php location.
...
#define XmppJidPrefix @"krownuser_"  //Fixed by Karol 11/18/2015 [krownUser_ -> krownuser_]

#define CHAT_SERVER_ADDRESS @"83.221.132.24"// @"doubbletaptesting.com"//
#define XMPP_HOST         @"http://83.221.132.24:9090"//  @"doubbletaptesting.com"//
#define XMPP_OUTGOING_SERVER  @"http://83.221.132.24:9090"// @"doubbletaptesting.com"//
#define XMPP_HOST_PORT          5222

#define CHAT_SERVER_ADDRESS_Event @"83.221.132.24"
...
extern NSString *const METHOD_ADD_EVENT;
...
extern NSString *const PARAM_ENT_USER_EVENTID;
...
extern NSString *const PARAM_ENT_EVENT_ID;
extern NSString *const PARAM_ENT_EVENT_END_TIME;
extern NSString *const PARAM_ENT_EVENT_START_TIME;
extern NSString *const PARAM_ENT_EVENT_PLACE_NAME;
extern NSString *const PARAM_ENT_EVENT_PLACE_LAT;
extern NSString *const PARAM_ENT_EVENT_PLACE_LONG;
extern NSString *const PARAM_ENT_EVENT_PLACE_COUNTRY;
extern NSString *const PARAM_ENT_EVENT_PLACE_CITY;
extern NSString *const PARAM_ENT_MEMBER_ID;
extern NSString *const PARAM_ENT_EVENT_ATTENDING;
extern NSString *const PARAM_ENT_EVENT_PLACE_STREET;
extern NSString *const PARAM_ENT_EVENT_PLACE_ZIP;
extern NSString *const PARAM_ENT_EVENT_PLACE_STATE;
