...
NSString *const METHOD_FINDMATCHES=@"findEventMatches";
...
NSString *const METHOD_ADD_EVENT=@"addeventsandmembers";
...
NSString *const PARAM_ENT_USER_EVENTID=@"ent_event_id";
...
//Events
NSString *const PARAM_ENT_EVENT_ID=@"id";
NSString *const PARAM_ENT_EVENT_END_TIME=@"end_time";
NSString *const PARAM_ENT_EVENT_START_TIME=@"start_time";
NSString *const PARAM_ENT_EVENT_PLACE_NAME=@"place_name";
NSString *const PARAM_ENT_EVENT_PLACE_LAT=@"place_latitude";
NSString *const PARAM_ENT_EVENT_PLACE_LONG=@"place_longitude";
NSString *const PARAM_ENT_EVENT_PLACE_COUNTRY=@"place_country";
NSString *const PARAM_ENT_EVENT_PLACE_CITY=@"place_city";
NSString *const PARAM_ENT_MEMBER_ID=@"member_id";
NSString *const PARAM_ENT_EVENT_ATTENDING=@"attending_count";
NSString *const PARAM_ENT_EVENT_PLACE_STREET=@"place_street";
NSString *const PARAM_ENT_EVENT_PLACE_ZIP=@"place_zip";
NSString *const PARAM_ENT_EVENT_PLACE_STATE=@"place_state";
