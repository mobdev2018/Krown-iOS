...
- (void)layoutSubviews {
    ...
    /*****************************/
    NSString *strlabelText = label.text;
    if (strlabelText == nil) strlabelText = @"";
    
    NSAttributedString *labelString = [[NSAttributedString alloc] initWithString:strlabelText attributes:@{NSFontAttributeName: label.font}];
    CGRect rectLabel = [labelString boundingRectWithSize:(CGSize){CGFLOAT_MAX, CGFLOAT_MAX} options:NSStringDrawingUsesLineFragmentOrigin context:nil];
    ...
    NSMutableParagraphStyle *styleDetail = [[NSParagraphStyle defaultParagraphStyle] mutableCopy];
    [styleDetail setLineBreakMode:detailsLabel.lineBreakMode];
    NSDictionary *attributes = @{NSFontAttributeName:detailsLabel.font, NSParagraphStyleAttributeName: styleDetail};
    NSAttributedString *detailText = [[NSAttributedString alloc] initWithString:detailsLabel.text attributes:attributes];
    CGRect detailsLabelRect = [detailText boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin context:nil];
