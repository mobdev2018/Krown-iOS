...
- (void)setup
{
    ...
    [self setBackgroundColor:[UIColor colorWithRed:25.0/255.0 green:35.0/255.0 blue:46.0/255 alpha:1.0]];
...
//    UIImage *imgButton = [UIImage imageNamed:@"three-dot-icon.png"];
   ...
   // [rightbarbutton setImage:imgButton forState:UIControlStateNormal];
    ...
    [btnSelectAll.titleLabel setFont:[UIFont systemFontOfSize:14]];
   ...
   // [btnDeleteMsgs setImage:imgButton forState:UIControlStateNormal];
    ...
    [btnDeleteMsgs.titleLabel setFont:[UIFont systemFontOfSize:14]];
...
//    }
    ...
    if ([arrayIndexSelected containsObject:[NSNumber numberWithInteger:indexPath.row]]) {
...
-(void)callForDeleteRowAtIndex:(NSInteger)indexRow
{
    if([self.delegate respondsToSelector:@selector(deleteRowAtIndex:)])
    {
        [self.delegate deleteRowAtIndex:(int)indexRow];
    }
}
...
{
    NSNumber *indexSelected = [NSNumber numberWithInteger:sender.tag];
