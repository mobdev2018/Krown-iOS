...
+ (UIColor *)js_iOS7OutgoingBubbleColor{

    return [UIColor colorWithRed:35.0/255.0 green:35.0/255.0 blue:35.0/255.0 alpha:1.0f];
}
+ (UIColor *)js_iOS7IncomingBubbleColor{
