...
-(CGSize)getExpectedLabelSize:(UILabel *)lbl For:(CGSize)maximumLabelSize
{
    ...
    [style setLineBreakMode:lbl.lineBreakMode];
    NSDictionary *sizeAttributes = @{NSFontAttributeName:font, NSParagraphStyleAttributeName: style};
    NSAttributedString *attributeText = [[NSAttributedString alloc] initWithString:lbl.text attributes:sizeAttributes];
    CGRect rect = [attributeText boundingRectWithSize:(CGSize){maximumLabelSize.width, CGFLOAT_MAX} options:NSStringDrawingUsesLineFragmentOrigin context:nil];
